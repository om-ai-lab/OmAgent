...
task1 = simple_task(task_def_name='ImageChat', task_reference_name='image_chat', inputs={'image_url': 'https://media.githubusercontent.com/media/om-ai-lab/OmAgent/refs/heads/main/docs/images/intro.png'})
