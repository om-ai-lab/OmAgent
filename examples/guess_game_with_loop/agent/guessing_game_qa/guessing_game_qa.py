...
class GuessingGameQA(BaseLLMBackend, BaseWorker):
    ...
    def _run(self, *args, **kwargs):
        ...
        # Handle web search flow for gathering contextual info
            ...
            self.callback.info(self.workflow_instance_id, progress='Outfit QA', message='Search for weather information')
            ...
            if execution_status == "success":
                ...
                feedback.append('The weather information is provided detailly and specifically, and satisfied the requirement, dont need to ask for more weather information.')
