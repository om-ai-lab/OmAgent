...
from omagent_core.clients.devices.lite_version.programmatic import ProgrammaticClient
...
def main():
    ...
    cot_workflow.set_input(query=workflow.input('query'), examples=workflow.input('examples'), options=workflow.input('options'))
