...
class InputInterface(BaseWorker):
    ...
    def _run(self, *args, **kwargs):
        ...
        user_input = self.input.read_input(workflow_instance_id=self.workflow_instance_id, input_prompt='Hello, I am your travel assistant. Please tell me, where would you like to go?')
