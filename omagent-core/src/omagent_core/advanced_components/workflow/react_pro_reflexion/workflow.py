    ...
    def _configure_tasks(self):
        ...
        self.reflect_task = simple_task(
            ...
            inputs={
                ...
                'context': self.react_output_task.output('context')
            }
        )
        
        # Switch task to control reflect execution
        self.switch_task = SwitchTask(
            task_ref_name='reflect_switch',
            case_expression=self.react_output_task.output('is_final')
        )
        self.switch_task.switch_case(False, self.reflect_task)
        ...
        self.outer_loop_task = DoWhileTask(
            ...
            tasks=[self.react_loop_task, self.react_output_task, self.switch_task],
            termination_condition='(($.react_output.is_final == true))'
        )
