...
from omagent_core.advanced_components.workflow.dnc.agent.conqueror.conqueror import TaskConqueror
from omagent_core.advanced_components.workflow.dnc.agent.divider.divider import TaskDivider
from omagent_core.advanced_components.workflow.dnc.agent.construct_dnc_payload.construct_dnc_payload import ConstructDncPayload
from omagent_core.advanced_components.workflow.dnc.agent.task_exit_monitor.task_exit_monitor import TaskExitMonitor
from omagent_core.advanced_components.workflow.dnc.agent.task_rescue.rescue import TaskRescue
from omagent_core.advanced_components.workflow.dnc.agent.structure_update.structure_update import StructureUpdate
...
class DnCWorkflow(ConductorWorkflow):
    ...
    def _configure_tasks(self):
        ...
        self.structure_update_task = simple_task(
            ...
            inputs={'dnc_structure': self.construct_dnc_payload_task.output('dnc_structure')}
        )
        ...
        self.task_exit_monitor_task = simple_task(
            task_def_name=TaskExitMonitor,
            task_reference_name='task_exit_monitor'
        )
