...
from .opt import MessageType, Role
...
class Message(BaseModel):
    """
    - role (str): The role of this message. Choose from 'user', 'assistant', 'system', 'thinking'.
...
class MQLinkage(BaseModel):
    """
    - mq_user (str): MQ username.
    - mq_password (str): MQ password.
    - mq_host (str): MQ host.
    - mq_port (str): MQ port.
    - que_id (str): MQ queue id.
    """
